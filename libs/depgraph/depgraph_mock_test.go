...
type mockItemDepsCb func(staticAttrs, modifiableAttrs mockItemAttrs) []depgraph.Dependency
...
func (m mockItem) Dependencies() []depgraph.Dependency {
	if m.depsCb != nil {
		return m.depsCb(m.staticAttrs, m.modifiableAttrs)
	}
