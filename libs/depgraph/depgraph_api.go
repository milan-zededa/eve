...
// type can be for example "Linux bridge"). Configurator is essentially a handler/driver
// for items of the same type, implementing Create, Modify and Delete operations.
