...
func loadOrSign(path string, priv crypto.Signer, csr *x509.CertificateRequest) (*x509.Certificate, error) {
...
func selfSign(priv crypto.Signer, csr *x509.CertificateRequest) (*x509.Certificate, error) {
