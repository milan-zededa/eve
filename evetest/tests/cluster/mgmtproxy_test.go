...
// testAppImageName/testAppImageTag identify the container image used by
// both the raw kubectl-applied app and the EVE-API-deployed app: the same
// evetest-ubuntu-ctr test fixture (testapps/ubuntu-ctr), published to
// Docker Hub by the repo's publish workflow.
//
// TODO: switch back to "lfedge/evetest-ubuntu-ctr" once that workflow has
// published 1.1 -- this personal namespace is a stand-in until then.
const (
