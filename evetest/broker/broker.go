...
type device struct {
	...
	// netbootInstalled is set once a NetworkBootFirst device's first
...
// power-on under NetworkBootFirst (see provider.DeviceSpec), this also runs
...
// NetworkBootFirst devices in the same test (e.g. a netbooted cluster) need
...
func (b *broker) PowerOnDevice(
	...
	if eveDevice.NetworkBootFirst && !eveDevice.netbootInstalled {
