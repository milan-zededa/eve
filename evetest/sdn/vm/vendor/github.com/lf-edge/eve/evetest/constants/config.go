...
const (
	...
	// It points to libvirt's default storage pool directory, as libvirt is the
	// default device provider (see DefaultBrokerProvider).
	DefaultBrokerImageDir = "/var/lib/libvirt/images"
)
