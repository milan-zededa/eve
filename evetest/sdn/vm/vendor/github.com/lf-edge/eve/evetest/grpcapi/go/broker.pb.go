...
type EveConfig struct {
	...
	GlobalJson        string                 `protobuf:"bytes,8,opt,name=global_json,json=globalJson,proto3" json:"global_json,omitempty"`
	OverrideJson      string                 `protobuf:"bytes,9,opt,name=override_json,json=overrideJson,proto3" json:"override_json,omitempty"`
	BootstrapConfigPb []byte                 `protobuf:"bytes,10,opt,name=bootstrap_config_pb,json=bootstrapConfigPb,proto3" json:"bootstrap_config_pb,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type ConsoleProperties struct {
	...
	// Interactive clients (e.g., terminals) should disable local echo when this is true.
	...
	// Clients may need to wrap or interpret data accordingly.
...
const file_broker_proto_rawDesc = "" +
	...
	"\tclient_id\x18\x01 \x01(\tR\bclientId\"\xfc\x02\n" +
	"\tEveConfig\x12\x1f\n" +
	...
	"\bssh_keys\x18\a \x03(\tR\asshKeys\x12\x1f\n" +
	"\vglobal_json\x18\b \x01(\tR\n" +
	"globalJson\x12#\n" +
	"\roverride_json\x18\t \x01(\tR\foverrideJson\x12.\n" +
	"\x13bootstrap_config_pb\x18\n" +
	" \x01(\fR\x11bootstrapConfigPb\"\x82\x02\n" +
	...
	"\x06telnet\x18\x02 \x01(\bR\x06telnet\"\x87\x01\n" +
...
var file_broker_proto_goTypes = []any{
	...
	(*ConsoleProperties)(nil),          // 20: org.lfedge.evetest.ConsoleProperties
	(*ConnectConsoleResponse)(nil),     // 21: org.lfedge.evetest.ConnectConsoleResponse
	(ArchType)(0),                      // 22: org.lfedge.evetest.ArchType
	(*ImageRef)(nil),                   // 23: org.lfedge.evetest.ImageRef
	(*EVEDevice)(nil),                  // 24: org.lfedge.evetest.EVEDevice
	(*SDNConfig)(nil),                  // 25: org.lfedge.evetest.SDNConfig
...
var file_broker_proto_depIdxs = []int32{
	...
	23, // 1: org.lfedge.evetest.BuildImageRequest.image:type_name -> org.lfedge.evetest.ImageRef
	...
	23, // 4: org.lfedge.evetest.PushImageRequest.image:type_name -> org.lfedge.evetest.ImageRef
	24, // 5: org.lfedge.evetest.SetupDevicesRequest.devices:type_name -> org.lfedge.evetest.EVEDevice
	25, // 6: org.lfedge.evetest.SetupDevicesRequest.sdn_config:type_name -> org.lfedge.evetest.SDNConfig
	17, // 7: org.lfedge.evetest.ConnectConsoleRequest.connect:type_name -> org.lfedge.evetest.DeviceControlRequest
	20, // 8: org.lfedge.evetest.ConnectConsoleResponse.connect_reply:type_name -> org.lfedge.evetest.ConsoleProperties
	...
	21, // 35: org.lfedge.evetest.Broker.ConnectConsoleToDevice:output_type -> org.lfedge.evetest.ConnectConsoleResponse
