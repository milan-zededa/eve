...
require (
	...
	github.com/lf-edge/eve/evetest v0.0.0-20260817132818-df7a63b03d3b
...
// to upstream.
replace github.com/lf-edge/eve/evetest => github.com/milan-zededa/eve/evetest v0.0.0-20260817142625-ba19a0c2ceec
