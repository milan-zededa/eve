...
require (
	...
	github.com/lf-edge/eve-api/go v0.0.0-20240517115539-b5a8cd6c001a
...
replace github.com/lf-edge/eve-api/go => github.com/milan-zededa/eve-api/go v0.0.0-20240520090751-6e5d1eaed411
