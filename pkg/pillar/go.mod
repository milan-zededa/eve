...
require (
	...
	github.com/lf-edge/eve-libs v0.0.0-20250626183242-adaa3e5c923d
...
replace github.com/lf-edge/eve-libs => github.com/milan-zededa/eve-libs v0.0.0-20250702182449-0b9b6ae63b29
