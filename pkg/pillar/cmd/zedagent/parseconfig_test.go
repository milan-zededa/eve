...
func TestParsePNAC(t *testing.T) {
	...
	g.Expect(scepProfile.CSRProfile.Subject.Organization).To(Equal("Test Organization"))
	g.Expect(scepProfile.CSRProfile.Subject.OrganizationalUnit).To(Equal("Unit Test"))
	g.Expect(scepProfile.CSRProfile.Subject.Country).To(Equal("US"))
	g.Expect(scepProfile.CSRProfile.Subject.State).To(Equal("TestState"))
	g.Expect(scepProfile.CSRProfile.Subject.Locality).To(Equal("TestCity"))
