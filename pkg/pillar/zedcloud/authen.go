...
// Verify the integrity of the payload inside AuthContainer.
...
// VerifyZControllerCert - unmarshal and verify the content of ZControllerCert
// receiver from the controller.
// Returns content of the signing certificate and the verification error/nil value.
func VerifyZControllerCert(log *base.LogObject, content []byte) ([]byte, error) {
