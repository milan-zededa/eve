...
type CellularConfig struct {
	...
	// etc.
	// If only one APN configuration is defined (see access_points above), this can be left unspecified.
	// In that case, the SIM slot matched by the APN configuration will be automatically activated.
	//
	// Deprecated: This field does not support matching SIM cards by ICCID (which is more suitable for eSIM)
	// and does not allow multiple active or standby SIM cards. Instead, use CellularAccessPoint.sim_activation_mode
	// to select active SIM cards. If any CellularAccessPoint in access_points has sim_activation_mode set,
	// this field will be ignored. Otherwise, EVE will use it for backward compatibility with older versions.
	//
...
type CellularAccessPoint struct {
	...
	// SIM card slot this configuration applies to:
	// 0 - unspecified
	// 1 - first SIM slot
	// 2 - second SIM slot
	// etc.
	// If unspecified, the configuration is matched to the SIM card by ICCID (see sim_iccid field below).
	// If only one CellularAccessPoint is defined in CellularConfig, both sim_slot and sim_iccid
	// may be omitted. In that case, EVE will apply this config to whatever SIM card or eSIM profile
	// is already activated. And if the activated SIM slot is empty but another slot has a SIM
	// card inserted, EVE will automatically switch to the slot with a card present.
	...
	AuthProtocol CellularAuthProtocol `protobuf:"varint,3,opt,name=auth_protocol,json=authProtocol,proto3,enum=org.lfedge.eve.config.CellularAuthProtocol" json:"auth_protocol,omitempty"`
	// Cipher data may contain:
	//   - user credentials for the default bearer
	//     (see EncryptionBlock, fields cellular_net_username and cellular_net_password)
	//   - user credentials for the attach bearer
	//     (see EncryptionBlock, fields cellular_net_attach_username and cellular_net_attach_password)
	//   - SM-DP+ address and activation code for installing a new eSIM profile
	//     used only if provision_esim_profile is enabled
	//     (see EncryptionBlock, field esim_profile_provisioning)
	...
	// Leave undefined if attach_apn is not specified.
	AttachAuthProtocol CellularAuthProtocol `protobuf:"varint,11,opt,name=attach_auth_protocol,json=attachAuthProtocol,proto3,enum=org.lfedge.eve.config.CellularAuthProtocol" json:"attach_auth_protocol,omitempty"`
	// ICCID of the SIM card this configuration applies to.
	// Can be used alongside or instead of sim_slot.
	// Especially useful for matching virtual eSIM profiles, since sim_slot may refer
	...
	// sent from the controller inside cipher_data (EncryptionBlock.esim_profile_provisioning).
	ProvisionEsimProfile bool `protobuf:"varint,13,opt,name=provision_esim_profile,json=provisionEsimProfile,proto3" json:"provision_esim_profile,omitempty"`
	// SIM role in the context of multi-SIM operation.
	// If only one APN configuration is defined in CellularConfig, this can be left unspecified.
	// In that case, the SIM slot matched by the APN configuration will be automatically activated.
	SimActivationMode evecommon.SimActivationMode `protobuf:"varint,14,opt,name=sim_activation_mode,json=simActivationMode,proto3,enum=org.lfedge.eve.common.SimActivationMode" json:"sim_activation_mode,omitempty"`
}
...
func (x *CellularAccessPoint) GetAuthProtocol() CellularAuthProtocol {
	...
	return CellularAuthProtocol_CELLULAR_AUTH_PROTOCOL_NONE
}
...
func (x *CellularAccessPoint) GetAttachAuthProtocol() CellularAuthProtocol {
	if x != nil {
...
func (x *CellularAccessPoint) GetSimIccid() string {
	if x != nil {
		return x.SimIccid
	}
	return ""
...
func (x *CellularAccessPoint) GetProvisionEsimProfile() bool {
	if x != nil {
		return x.ProvisionEsimProfile
	}
	return false
}

func (x *CellularAccessPoint) GetSimActivationMode() evecommon.SimActivationMode {
	if x != nil {
...
var file_config_netconfig_proto_rawDesc = []byte{
	...
	0x1a, 0x13, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2f, 0x6e, 0x65, 0x74, 0x63, 0x6d, 0x6e, 0x2e,
	...
	0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd8, 0x02,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x54, 0x79, 0x70,
	0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x2d, 0x0a, 0x02, 0x69, 0x70, 0x18, 0x06, 0x20,
	...
	0x65, 0x63, 0x52, 0x02, 0x69, 0x70, 0x12, 0x3b, 0x0a, 0x03, 0x64, 0x6e, 0x73, 0x18, 0x07, 0x20,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x0a, 0x63, 0x69, 0x70, 0x68, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61,
	0x1a, 0x45, 0x0a, 0x0b, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12,
	...
	,
...
var file_config_netconfig_proto_goTypes = []interface{}{
	(CellularAuthProtocol)(0),            // 0: org.lfedge.eve.config.CellularAuthProtocol
	...
	(*WifiConfigCryptoblock)(nil),        // 8: org.lfedge.eve.config.WifiConfig.cryptoblock
	(NetworkType)(0),                     // 9: org.lfedge.eve.config.NetworkType
	(*Ipspec)(nil),                       // 10: org.lfedge.eve.config.ipspec
	(*ZnetStaticDNSEntry)(nil),           // 11: org.lfedge.eve.config.ZnetStaticDNSEntry
	(*ProxyConfig)(nil),                  // 12: org.lfedge.eve.config.ProxyConfig
	(*ACE)(nil),                          // 13: org.lfedge.eve.config.ACE
	(WirelessType)(0),                    // 14: org.lfedge.eve.config.WirelessType
	(*ConnectivityProbe)(nil),            // 15: org.lfedge.eve.config.ConnectivityProbe
	...
	(evecommon.SimActivationMode)(0),     // 19: org.lfedge.eve.common.SimActivationMode
	(WiFiKeyScheme)(0),                   // 20: org.lfedge.eve.config.WiFiKeyScheme
}
var file_config_netconfig_proto_depIdxs = []int32{
	9,  // 0: org.lfedge.eve.config.NetworkConfig.type:type_name -> org.lfedge.eve.config.NetworkType
	10, // 1: org.lfedge.eve.config.NetworkConfig.ip:type_name -> org.lfedge.eve.config.ipspec
	11, // 2: org.lfedge.eve.config.NetworkConfig.dns:type_name -> org.lfedge.eve.config.ZnetStaticDNSEntry
	12, // 3: org.lfedge.eve.config.NetworkConfig.entProxy:type_name -> org.lfedge.eve.config.ProxyConfig
	3,  // 4: org.lfedge.eve.config.NetworkConfig.wireless:type_name -> org.lfedge.eve.config.WirelessConfig
	13, // 5: org.lfedge.eve.config.NetworkAdapter.acls:type_name -> org.lfedge.eve.config.ACE
	14, // 6: org.lfedge.eve.config.WirelessConfig.type:type_name -> org.lfedge.eve.config.WirelessType
	...
	15, // 11: org.lfedge.eve.config.CellularConnectivityProbe.custom_probe:type_name -> org.lfedge.eve.config.ConnectivityProbe
	0,  // 12: org.lfedge.eve.config.CellularAccessPoint.auth_protocol:type_name -> org.lfedge.eve.config.CellularAuthProtocol
	...
	0,  // 17: org.lfedge.eve.config.CellularAccessPoint.attach_auth_protocol:type_name -> org.lfedge.eve.config.CellularAuthProtocol
	19, // 18: org.lfedge.eve.config.CellularAccessPoint.sim_activation_mode:type_name -> org.lfedge.eve.common.SimActivationMode
	20, // 19: org.lfedge.eve.config.WifiConfig.keyScheme:type_name -> org.lfedge.eve.config.WiFiKeyScheme
	8,  // 20: org.lfedge.eve.config.WifiConfig.crypto:type_name -> org.lfedge.eve.config.WifiConfig.cryptoblock
	16, // 21: org.lfedge.eve.config.WifiConfig.cipherData:type_name -> org.lfedge.eve.common.CipherBlock
